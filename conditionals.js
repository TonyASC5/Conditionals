...
// line argument
console.log("You find yourself in a store shopping.. you see a jacket that costs $40 and adds 20 points to your health,");
console.log("candy that costs $10, paint that costs $30, and a hammer that costs $70. You can chose to by nothing.");
if (item == "jakcet")
{
    console.log(" You Bought a Jakcet" + (health + 20) + (money-40));

}
else if (item == " candy"){

    console.log ("You bought candy" + (money-10));
}
else if (item == "paint"){
    console.log("you bought paint" + (money-30));

}
else if (item == "hammer")
{

console.log("you bought a hammer" + (money-70));
